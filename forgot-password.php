...
<head>
  <title> SSA Devastanam | | Forgot Password</title>
...
<body>
  ...
  <div class="study">
    <div class="container">
      ...
      <form class="row contact_us_form" action="forgot-password.php" method="post" name="changepassword"
        ...
        <div class="form-group col-md-12">
          <a href="register.php" class="btn btn-success"><i class="ft-user"></i> Register</a> <strong>Register with
            us!!!!</strong>
        </div>
        <div class="form-group col-md-12">
