...
$_SESSION["token"]=bin2hex(random_bytes(32));
 ?>
                                    ...
                                    <form action="app/district_crud.php" method="post">
                                      <?php
  $stmt=$conn->prepare("SELECT * FROM `district` WHERE id='".$_GET['id']."' ");
  $stmt->execute();
...
<div class="col-md-6">
  <label>District</label>
    <input class="postName form-control" name="district" value="<?php echo $key['district'];?>" pattern="^[a-z A-Z ]+$"  required><br>
</div>
