...
$_SESSION["token"]=bin2hex(random_bytes(32));
 ?>
                                    <form action="app/taluka_crud.php" method="post">
...
<div class="col-md-6">
  <label>District</label>
    <select class="postName1 form-control" style=" width: 375px" name="district1" data-live-search="true" id="state"  required>
    </select>
...
<div class="col-md-6">
  <label>Taluka</label>
    <input class="postName1 form-control" name="taluka"  required><br>
</div>
