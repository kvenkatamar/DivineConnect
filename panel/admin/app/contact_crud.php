...
use PHPMailer\PHPMailer\Exception;
 ...
 try {
		...
		{
			// echo "INSERT INTO `contact`(`name1`,`email1`, `mobile`, `msg`) VALUES ('".$_POST['name1']."','".$_POST['email1']."','".$_POST['mobile']."','".$_POST['msg']."')";exit;
			$stmt = $conn->prepare("INSERT INTO `contact`(`name1`,`email1`, `mobile`, `msg`) VALUES ('".$_POST['name1']."','".$_POST['email1']."','".$_POST['mobile']."','".$_POST['msg']."')");
		...
		if (isset($_POST['submit'])) 
      {
        $stmt=$conn->prepare("SELECT * FROM `contact` WHERE email='".$_POST['email']."'");
        $stmt->execute();
        ...
        //echo $email; exit;
              ...
              $stmt = $conn->prepare("UPDATE `contact` SET password='".$password."' WHERE email='".$_POST['email']."' ");
              $stmt->execute();
